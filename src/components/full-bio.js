    ...
    <div className='container'>
      ...
      <div className='row'>
        ...
        <div className='ten columns offset-by-one column'>
          ...
          <br/>
          <h4><b>Growth.</b></h4>
          <h6>I graduated highschool in the 2010 and went to college for Business Administration, planning to eventually pursue an MBA. After a month I was bored and ready to move one, but stayed for a year and a half while I skipped className and spent most of my spare time trying to lauch and grow ideas. I tried (and failed) at them all: t-shirts, small business marketing, party promotion, real estate investments.</h6>
          ...
          <hr/>
          <h6><b>⚡️ Do Everything, See Everything. Spread Love & Share Knowledge. Move Fast. Fail Faster. Always Build Great Product.</b></h6>
          <hr/>
          <Signature />
        </div>
      </div>
